...
{
    public partial class Northwind_48_BTCContext : DbContext
    {
        public Northwind_48_BTCContext()
        {
        }

        public Northwind_48_BTCContext(DbContextOptions<Northwind_48_BTCContext> options)
            : base(options)
        {
        }
